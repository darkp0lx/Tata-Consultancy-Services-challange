...
export class FormValidationHelper {
  ...
  setStateField = (
    prevForm: any,
    fields: Array<iSelectModel | iCheckboxModel | iInputModel>
  ) => {
    let form = { ...prevForm }
    ...
    for (let field of fields) {
      ...
      field.isVisible =
        typeof field.isVisible === 'boolean'
          ? field.isVisible
          : field.isRequired !== false
      field.value =
        typeof field.value === 'undefined' ? form[key].value : field.value
  ...
  getStateInput = (form: any, event: any) => {
    ...
    let validations = this.runValidations(
      value,
      form[fieldName],
      validity,
      form
